...
export default function Nav() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden md:flex flex-col fixed left-0 top-0 bottom-0 w-56 bg-[#0D0E14] border-r border-white/8 z-30 px-3 py-5">
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 rounded-xl text-sm text-white/30 hover:text-white/60 hover:bg-white/5 transition-colors mt-2"
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5">
      ...
      {/* Mobile bottom nav */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-30 bg-[#0D0E14]/95 backdrop-blur border-t border-white/8 flex items-center justify-around px-2 pb-safe">
